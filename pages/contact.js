          ...
          <div className="mt-8 sm:mt-10 md:mt-12 lg:mt-16">
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
              <div className="px-4 sm:px-5 md:px-6 py-6 sm:py-7 md:py-8">
                <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-5 md:mb-6">Frequently Asked Questions</h2>
                
                <div className="space-y-4 sm:space-y-5 md:space-y-6">
                  <div>
                    <h3 className="text-base sm:text-lg font-medium text-gray-900">How quickly can you fill remote positions?</h3>
                  ...
                  <div>
                    <h3 className="text-base sm:text-lg font-medium text-gray-900">How do you ensure data security for remote staff?</h3>
                    <p className="mt-1 sm:mt-2 text-sm sm:text-base text-gray-600">
