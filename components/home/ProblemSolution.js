  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden opacity-30">
        <div className="absolute -bottom-16 -right-16 w-64 h-64 bg-blue-200 rounded-full animate-blob animation-delay-2000"></div>
        <div className="absolute top-32 -left-16 w-64 h-64 bg-indigo-200 rounded-full animate-blob"></div>
        <div className="absolute top-1/2 right-1/4 w-48 h-48 bg-purple-200 rounded-full animate-blob animation-delay-4000"></div>
        <div className="absolute bottom-1/3 left-1/4 w-32 h-32 bg-teal-200 rounded-full animate-blob animation-delay-2000"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className={`text-center transition-all duration-1000 transform ${isVisible ? 'translate-y-0 opacity-100 animate-fadeInUp' : 'translate-y-10 opacity-0'}`}>
          <Badge variant="primary" className="mb-4 animate-pulse">Healthcare Staffing Challenges</Badge>
        ...
        {/* Tabs */}
        <div className={`flex justify-center mt-12 mb-8 transition-all duration-700 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
        ...
        {/* Problems grid */}
        <div className={`mt-6 grid gap-8 md:grid-cols-3 transition-all duration-500 ease-in-out transform ${activeTab === 'problems' ? 'translate-x-0 opacity-100' : 'translate-x-10 opacity-0 hidden'}`}>
          {problems.map((problem, index) => (
            ...
            >
              <CardHeader className="flex items-start space-x-4">
                <div className="p-3 rounded-full bg-red-100 shadow-md transition-all duration-300 hover:shadow-lg hover:bg-red-200 transform hover:scale-105">
                  {problem.icon}
                </div>
                <div>
              ...
              <CardContent>
                <p className="text-gray-600 mt-3">{problem.description}</p>
              </CardContent>
            </Card>
          ))}
        </div>
        ...
        {/* Solutions grid */}
        <div className={`mt-6 grid gap-8 md:grid-cols-3 transition-all duration-500 ease-in-out transform ${activeTab === 'solutions' ? 'translate-x-0 opacity-100' : 'translate-x-10 opacity-0 hidden'}`}>
          {solutions.map((solution, index) => (
            ...
            >
              <CardHeader className="flex items-start space-x-4">
                <div className="p-3 rounded-full bg-green-100 shadow-md transition-all duration-300 hover:shadow-lg hover:bg-green-200 transform hover:scale-105">
                  {solution.icon}
                </div>
                <div>
              ...
              <CardContent>
                <p className="text-gray-600 mt-3">{solution.description}</p>
              </CardContent>
            </Card>
          ))}
        </div>

        <div className={`mt-16 text-center transition-all duration-1000 delay-500 transform ${isVisible ? 'translate-y-0 opacity-100 animate-fadeInUp' : 'translate-y-10 opacity-0'}`}>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Button href="/intake" size="lg" rounded withAnimation className="animate-pulse hover:animate-none">
              Start Staffing Now
            </Button>
