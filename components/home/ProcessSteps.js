  ...
  return (
    <section className="py-24 bg-gradient-to-b from-gray-50 to-white overflow-hidden relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-20 -right-20 w-64 h-64 bg-blue-100 rounded-full opacity-30 animate-blob animation-delay-4000"></div>
        <div className="absolute bottom-32 -left-12 w-48 h-48 bg-indigo-100 rounded-full opacity-40 animate-blob"></div>
        <div className="absolute top-1/3 right-1/4 w-32 h-32 bg-purple-100 rounded-full opacity-30 animate-blob animation-delay-2000"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-20">
          ...
          >
            <motion.span 
              className="inline-block px-4 py-1.5 text-sm font-semibold bg-blue-100 rounded-full text-blue-600 mb-5"
              animate={{ y: [0, -3, 0] }}
              transition={{ duration: 1.5, repeat: Infinity, ease: "easeInOut" }}
            >
              Our Proven Process
            </motion.span>
            <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-700 to-indigo-700 bg-clip-text text-transparent leading-tight mb-4">
        ...
        >
          ...
          >
            <motion.div 
              className="rounded-full flex-shrink-0 overflow-hidden w-20 h-20 md:w-32 md:h-32 bg-white shadow-xl flex items-center justify-center"
            ...
            <div className="hidden md:block md:w-1/3">
              <motion.div 
                className="relative rounded-2xl overflow-hidden shadow-xl h-48 md:h-64 group"
              ...
              >
                ...
                <motion.div 
                  ...
                  transition={{ duration: 2, repeat: Infinity }}
                >
                  <div className="text-white font-semibold text-xl">Discovery Call</div>
                </motion.div>
              </motion.div>
            </div>
          </motion.div>
          ...
          {/* Step 2 */}
          <motion.div 
            className="relative z-10 flex flex-col md:flex-row items-center gap-8 md:gap-16 mt-10 md:mt-16"
            variants={stepVariants}
            ...
            <div className="hidden md:block md:w-1/3">
              ...
              >
                ...
                <motion.div 
                  ...
                  transition={{ duration: 2, repeat: Infinity }}
                >
                  <div className="text-white font-semibold text-xl">Contract Signing</div>
                </motion.div>
              </motion.div>
            </div>
          </motion.div>
            ...
            <div className="hidden md:block md:w-1/3">
              ...
              >
                ...
                <motion.div 
                  ...
                  transition={{ duration: 2, repeat: Infinity }}
                >
                  <div className="text-white font-semibold text-xl">Onboarding Process</div>
                </motion.div>
              </motion.div>
            </div>
          </motion.div>
          ...
          >
            <motion.button
              className="inline-flex items-center px-8 py-4 text-lg font-medium text-white bg-gradient-to-r from-blue-600 to-indigo-600 rounded-full shadow-lg hover:from-blue-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transform transition-all duration-300"
